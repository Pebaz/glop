...
def lower(bc, op, bit8=False, bit7=False, byte1=None, arg1=None, arg2=None):
    if bit8:
        op = op | (1 << 7)  # Set the 8th bit

    if bit7:
        op = op | (1 << 6)  # Set the 7th bit
...
def write_bytecode():
    ...
    bc.write(0b10000011_00001001.to_bytes(2, 'big'))  # $ CALL32a @R1(-300, -300)
    ...
    bc.write(0b10000011_00111001.to_bytes(2, 'big'))  # $ CALL32EX @R1(-300, -300)
    bc.write((2954019116).to_bytes(4, 'little'))

    bc.write(0b10000011_00101001.to_bytes(2, 'big'))  # $ CALL32EXa @R1(-300, -300)
    bc.write((2954019116).to_bytes(4, 'little'))

    bc.write(0b11000011_00110001.to_bytes(2, 'big'))  # $ CALL64EXa -3
    bc.write((-3).to_bytes(8, 'little', signed=True))

    bc.write(0b00000001_00000001.to_bytes(2, 'big'))  # $ JMP32 R1  ;; Absolute Address
    bc.write(0b00000001_10000001.to_bytes(2, 'big'))  # $ JMP32cc R1  ;; Absolute Address
    bc.write(0b00000001_11000001.to_bytes(2, 'big'))  # $ JMP32cs R1  ;; Absolute Address

    bc.write(0b00000001_00010001.to_bytes(2, 'big'))  # $ JMP32 R1  ;; Relative Address
    bc.write(0b00000001_10010001.to_bytes(2, 'big'))  # $ JMP32cc R1  ;; Relative Address
    bc.write(0b00000001_11010001.to_bytes(2, 'big'))  # $ JMP32cs R1  ;; Relative Address

    bc.write(0b10000001_00000001.to_bytes(2, 'big'))  # $ JMP32 R1 -3  ;; Absolute Address
    bc.write((-3).to_bytes(4, 'little', signed=True))

    bc.write(0b10000001_00010001.to_bytes(2, 'big'))  # $ JMP32 R1 -3  ;; Relative Address
    bc.write((-3).to_bytes(4, 'little', signed=True))

    bc.write(0b10000001_00001001.to_bytes(2, 'big'))  # $ JMP32 @R1(-300, -300)  ;; Absolute Address
    bc.write((2954019116).to_bytes(4, 'little'))

    bc.write(0b10000001_00011001.to_bytes(2, 'big'))  # $ JMP32 @R1(-300, -300)  ;; Relative Address
    bc.write((2954019116).to_bytes(4, 'little'))

    bc.write(0b00000001_00011001.to_bytes(2, 'big'))  # $ JMP32 @R1  ;; Relative Address

    bc.write(0b00000001_00001001.to_bytes(2, 'big'))  # $ JMP32 @R1  ;; Absolute Address

    bc.write(0b01000001_00000001.to_bytes(2, 'big'))  # $ JMP64 1000  ;; Absolute Address
    bc.write((1000).to_bytes(8, 'little'))

    bc.write(0b01000001_00010001.to_bytes(2, 'big'))  # $ JMP64 1000  ;; Relative Address
    bc.write((1000).to_bytes(8, 'little'))
    ...
    bc.write(0b11110111_00000001.to_bytes(2, 'big'))  # $ MOVIbq R1, 1000
    bc.write((1000).to_bytes(8, 'little'))

    bc.write(0b11110111_00010001.to_bytes(2, 'big'))  # $ MOVIwq R1, 1000
    bc.write((1000).to_bytes(8, 'little'))

    bc.write(0b11110111_00100001.to_bytes(2, 'big'))  # $ MOVIdq R1, 1000
    bc.write((1000).to_bytes(8, 'little'))

    bc.write(0b11110111_00110001.to_bytes(2, 'big'))  # $ MOVIqq R1, 1000
    bc.write((1000).to_bytes(8, 'little'))
    ...
    bc.write(0b10111000_00000001.to_bytes(2, 'big'))  # $ MOVInd R1, (-300, -300)
    bc.write((2954019116).to_bytes(4, 'little'))

    bc.write(0b11111000_00000001.to_bytes(2, 'big'))  # $ MOVInq R1, (-30000, -30000)
    bc.write((11529215048034579760).to_bytes(8, 'little'))

    bc.write(0b01111000_01001001.to_bytes(2, 'big'))  # $ MOVInw @R1(-3, -3), (-3, -3)
    bc.write((36879).to_bytes(2, 'little'))
    bc.write((36879).to_bytes(2, 'little'))

    bc.write(0b10111000_01001001.to_bytes(2, 'big'))  # $ MOVInd @R1(-3, -3), (-300, -300)
    bc.write((36879).to_bytes(2, 'little'))
    bc.write((2954019116).to_bytes(4, 'little'))

    bc.write(0b11111000_01001001.to_bytes(2, 'big'))  # $ MOVInq @R1(-3, -3), (-30000, -30000)
    bc.write((36879).to_bytes(2, 'little'))
    bc.write((11529215048034579760).to_bytes(8, 'little'))

    bc.write(0b01111001_00000001.to_bytes(2, 'big'))  # $ MOVRELw R1, -1000
    bc.write((-1000).to_bytes(2, 'little', signed=True))

    bc.write(0b10111001_00000001.to_bytes(2, 'big'))  # $ MOVRELd R1, -1000
    bc.write((-1000).to_bytes(4, 'little', signed=True))

    bc.write(0b11111001_00000001.to_bytes(2, 'big'))  # $ MOVRELq R1, -1000
    bc.write((-1000).to_bytes(8, 'little', signed=True))

    bc.write(0b01111001_01001001.to_bytes(2, 'big'))  # $ MOVRELw @R1(-3, -3), -1000
    bc.write((36879).to_bytes(2, 'little'))
    bc.write((-1000).to_bytes(2, 'little', signed=True))

    bc.write(0b10111001_01001001.to_bytes(2, 'big'))  # $ MOVRELd @R1(-3, -3), -1000
    bc.write((36879).to_bytes(2, 'little'))
    bc.write((-1000).to_bytes(4, 'little', signed=True))

    bc.write(0b11111001_01001001.to_bytes(2, 'big'))  # $ MOVRELq @R1(-3, -3), -1000
    bc.write((36879).to_bytes(2, 'little'))
    bc.write((-1000).to_bytes(8, 'little', signed=True))
    ...
    bc.write(0b01110011_00100001.to_bytes(2, 'big'))  # $ MOVnd R1, R2 -1000
    bc.write((-1000).to_bytes(4, 'little', signed=True))

    bc.write(0b01110010_00101001.to_bytes(2, 'big'))  # $ MOVnw @R1, R2 -1000
    bc.write((-1000).to_bytes(2, 'little', signed=True))

    bc.write(0b01110011_00101001.to_bytes(2, 'big'))  # $ MOVnd @R1, R2 -1000
    bc.write((-1000).to_bytes(4, 'little', signed=True))

    bc.write(0b01110010_10101001.to_bytes(2, 'big'))  # $ MOVnw @R1, @R2(-3, -3)
    bc.write((36879).to_bytes(2, 'little'))

    bc.write(0b01110011_10101001.to_bytes(2, 'big'))  # $ MOVnd @R1, @R2(-300, -300)
    bc.write((2954019116).to_bytes(4, 'little'))

    bc.write(0b11110010_00101001.to_bytes(2, 'big'))  # $ MOVnw @R1(-3, -3), R2 -1000
    bc.write((36879).to_bytes(2, 'little'))
    bc.write((-1000).to_bytes(2, 'little', signed=True))

    bc.write(0b11110011_00101001.to_bytes(2, 'big'))  # $ MOVnd @R1(-300, -300), R2 -1000
    bc.write((2954019116).to_bytes(4, 'little'))
    bc.write((-1000).to_bytes(4, 'little', signed=True))

    bc.write(0b11110010_10101001.to_bytes(2, 'big'))  # $ MOVnw @R1(-3, -3), @R2(-3, -3)
    bc.write((36879).to_bytes(2, 'little'))
    bc.write((36879).to_bytes(2, 'little'))
