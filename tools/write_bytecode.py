...
def write_bytecode():
    ...
    bc.write(0b10000001_00001001.to_bytes(2, 'big'))  # JMP32 @R1(-300, -300)
    bc.write((2954019116).to_bytes(4, 'little'))

    bc.write(0b10000001_00011001.to_bytes(2, 'big'))  # JMP32 @R1(-300, -300)  ;; Rel
    bc.write((2954019116).to_bytes(4, 'little'))
    ...
    bc.write(0b11111000_00000001.to_bytes(2, 'big'))  # MOVInd R1, (-30000, -30000)
    ...
    bc.write(0b11111000_01001001.to_bytes(2, 'big'))  # MOVInd @R1(-3, -3), (-30000, -30000)
    bc.write((36879).to_bytes(2, 'little'))
    bc.write((11529215048034579760).to_bytes(8, 'little'))
